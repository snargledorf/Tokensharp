    ...
    where TTokenType : TokenType<TTokenType>, ITokenType<TTokenType>
{
    ...
    public static readonly TokenizerStateId<TTokenType> WhiteSpace = new(TokenType<TTokenType>.WhiteSpace.Identifier, false,
    ...
    public static readonly TokenizerStateId<TTokenType> Number = new(TokenType<TTokenType>.Number.Identifier, false,
    ...
    public static readonly TokenizerStateId<TTokenType> Text = new(TokenType<TTokenType>.Text.Identifier, false,
    ...
    public static TokenizerStateId<TTokenType> CreateTerminal(TTokenType tokenType) =>
        new($"({tokenType.Identifier})_terminal", true, tokenType);
